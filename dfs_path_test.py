...
if __name__ == '__main__':
    ...
    show_upstream_stations_graph(node_read, network_read, index, outdate, cutoff=6)
    print('____________________________________________________________________________')
    print(upstream_node_on_mainstream(node_read, network_read, index, 8, outdate))
    print('____________________________________________________________________________')
    show_downstream_stations(node_read, network_read, index, outdate)
    if outdate is True:
        write_path_file(node_read, network_read)
    STOP_TIME = time.time()
