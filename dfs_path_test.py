...
INPUT_NETWORK_FILE_SHP = os.path.relpath("test_data/songliao_cut_single_new.shp")
INPUT_NODE_FILE_SHP = os.path.relpath("test_data/stage_river_1h_20_hydrorivers.shp")
...
if __name__ == '__main__':
    ...
    print(upstream_node_on_mainstream(gpd_nodes_dataframe, gpd_network_dataframe, index, 10))
    print('____________________________________________________________________________')
